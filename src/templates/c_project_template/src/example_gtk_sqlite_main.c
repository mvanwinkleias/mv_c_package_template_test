...
* uncomment the [% project.package_to_variable_name %]_CFLAGS line in src/Makefile.am
* uncomment the [% project.package_to_variable_name %]_LDADD line in src/Makefile.am
